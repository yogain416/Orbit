...
contextBridge.exposeInMainWorld('api', {
  tasks: {
    ...
    setOnHold: (id, value) => ipcRenderer.invoke('tasks:setOnHold', id, value),
    getHeld: () => ipcRenderer.invoke('tasks:getHeld'),
    returnFromHold: (id, toDate) => ipcRenderer.invoke('tasks:returnFromHold', id, toDate),
